...
from etl.month_closing import *
from utils.constants import *

# Create blueprint object
bp = func.Blueprint()

# This function 'orchestrate' the monthly pipeline
# A Blueprint is used to make de azure function app more organized
@bp.route(route='monthly-closing')
